		...
		public function ui() {
			if ( $this->should_continue() ) { ?>
				...
				<div class="sui-cross-sell-bottom">
					...
					<img class="sui-image" src="<?php echo WP_SMUSH_URL . 'app/assets/images/dev-team.png'; ?>" srcset="<?php echo WP_SMUSH_URL . 'assets/images/dev-team@2x.png'; ?> 2x" alt="<?php esc_html_e( 'Try pro features for free!', 'wp-smushit' ); ?>">
				</div>
				<?php
			}
			?>
