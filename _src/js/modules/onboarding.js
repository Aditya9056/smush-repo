...
( function() {
	...
	WP_Smush.onboarding = {
		...
		submit_opt_in_modal: () => {
			...
			// const form = document.forms.opt_in;
			// alert(form.user_email);

			const mc_user_id = '53a1e972a043d1264ed082a5b';
			const mc_list_id = '4b14b58816';
			const mc_url = 'https://edublogs.us1.list-manage.com/subscribe/post-json?u='+mc_user_id+'&id='+mc_list_id+'&c=?';
 
			// Access the form element...
			const form = document.getElementById( 'opt_in_form' );
			...
			// const mc_xhr = new XMLHttpRequest();
			// mc_xhr.open('GET', mc_url);

			// const xhr = new XMLHttpRequest();
			// xhr.open('POST', ajaxurl + '?action=submit_opt_in_modal');
			// xhr.send();
		},
	};
