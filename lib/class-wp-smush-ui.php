		...
		function options_ui( $configure_screen = false ) {
			...
			<div class='wp-smush-setting-row wp-smush-basic'>
				...
				<div class="wp-smush-resize-settings-wrap<?php echo $resize_checked ? '' : ' hidden'?>">
					...
					<div class="wp-smush-size-error wp-smush-update-width hidden"><?php printf( esc_html__( "The width you've entered must be greater than or equal to your largest thumbnail width which is set at %dpx", "wp-smushit" ), $max_sizes['width'] ); ?></div>
					<div class="wp-smush-size-error wp-smush-update-height hidden"><?php printf( esc_html__( "The height you've entered must be greater than or equal to your largest thumbnail height which is set at %dpx", "wp-smushit" ), $max_sizes['height'] ); ?></div>
				</div>
