...
"use strict";
eval("\n\n(function ($) {\n\t'use strict';\n\n\t/**\n  * Quick Setup - Form Submit\n  */\n\n\t$('#smush-quick-setup-submit').on('click', function () {\n\t\tvar self = $(this);\n\n\t\t$.ajax({\n\t\t\ttype: 'POST',\n\t\t\turl: ajaxurl,\n\t\t\tdata: $('#smush-quick-setup-form').serialize(),\n\t\t\tbeforeSend: function beforeSend() {\n\t\t\t\t// Disable the button.\n\t\t\t\tself.attr('disabled', 'disabled');\n\n\t\t\t\t// Show loader.\n\t\t\t\t$('<span class=\"sui-icon-loader sui-loading\"></span>').insertAfter(self);\n\t\t\t},\n\t\t\tsuccess: function success(data) {\n\t\t\t\t// Enable the button.\n\t\t\t\tself.removeAttr('disabled');\n\t\t\t\t// Remove the loader.\n\t\t\t\tself.parent().find('span.spinner').remove();\n\n\t\t\t\t// Reload the Page.\n\t\t\t\tlocation.reload();\n\t\t\t}\n\t\t});\n\t});\n\n\t/**\n  * Quick Setup - Skip button\n  */\n\t$('.smush-skip-setup').on('click', function () {\n\t\tvar form = $('form#smush-quick-setup-form');\n\n\t\t$.ajax({\n\t\t\ttype: 'POST',\n\t\t\turl: ajaxurl,\n\t\t\tdata: form.serialize(),\n\t\t\tbeforeSend: function beforeSend() {\n\t\t\t\tform.find('.button').attr('disabled', 'disabled');\n\t\t\t}\n\t\t});\n\t});\n})(jQuery);//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./_src/js/modules/modals.js\n");
