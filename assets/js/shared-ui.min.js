...
/* WEBPACK VAR INJECTION */(function(global, ClipboardJS, A11yDialog) {var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var require;var require;var require;var require;/*!
 * WPMU DEV Shared UI
...
( function( $ ) {
	...
	$( '.sui-2-2-5 .sui-code-snippet:not(.sui-no-copy)' ).each( function( i ) {
...
( function( $ ) {
	...
	$( '.sui-2-2-5 .sui-notice-top:not(.sui-can-dismiss, .sui-cant-dismiss)' ).delay( 3000 ).slideUp( 'slow' );

	$( '.sui-2-2-5 .sui-notice-dismiss' ).click( function( e ) {
		e.preventDefault();
...
( function( $ ) {
	...
	SUI.showHidePassword = function() {
		...
		$( '.sui-2-2-5 .sui-password-group' ).each( function() {
			var $this = $( this ),
...
( function( $ ) {
	...
	$( '.sui-2-2-5 .sui-circle-score' ).each( function() {
...
( function( $ ) {
	...
	$( '.sui-2-2-5 select' ).each( function() {
		SUI.suiSelect( this );
	});
...
( function( $ ) {
	...
	$( '.sui-2-2-5 .sui-tabs' ).each( function() {
		SUI.suiTabs( this );
	});
...
( function( $ ) {
	...
	SUI.upload = function() {
		...
		$( '.sui-2-2-5 .sui-upload-group input[type="file"]' ).on( 'change', function( e ) {
