...
exports.setBlockTest = setBlockTest;
...
__webpack_require__(/*! ./style.scss */ "./_src/js/block/style.scss");
...
function addAttribute(settings, blockName) {
	...
	if ('core/image' === blockName) {
		...
		settings.attributes = (0, _assign2.default)(settings.attributes, {
			smushStats: {
				type: 'string'
			}
		});
...
var addInspectorControl = wp.element.createHigherOrderComponent(function (BlockEdit) {
	return function (props) {
		...
		image.fetch({ attribute: 'smush' }).done(function (img) {
			...
			// Image data fetched.
			for (var key in img.smush.sizes) {
...
function setBlockTest(blockType, attributes) {
...
wp.hooks.addFilter('blocks.getSaveElement', 'wp-smushit/set-block-save', setBlockTest);

// Our filter function
function setBlockCustomClassName(className, blockName) {
	return blockName === 'core/image' ? 'wp-shmushit-code' : className;
}

// Adding the filter
wp.hooks.addFilter('blocks.getBlockDefaultClassName', 'wp-smushit/set-block-custom-class-name', setBlockCustomClassName);
...
__webpack_require__(/*! ./block/index */ "./_src/js/block/index.js");
