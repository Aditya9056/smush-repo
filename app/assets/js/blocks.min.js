...
/******/ 	return __webpack_require__(__webpack_require__.s = "./_src/js/blocks.js");
/******/ })
/************************************************************************/
/******/ ({
...
function smushStats(stats) {
	...
	return React.createElement(
		'div',
		{ id: 'smush-stats', className: 'sui-smush-media smush-stats-wrapper hidden', style: { display: 'block' } },
		React.createElement(
			'table',
			{ className: 'wp-smush-stats-holder' },
			React.createElement(
				'thead',
				null,
				React.createElement(
			...
			React.createElement(
				'tbody',
				null,
				Object.keys(stats.sizes).map(function (item, i) {
					return React.createElement(
						'tr',
						{ key: i },
						React.createElement(
 ...
 */
var smushStatsControl = wp.element.createHigherOrderComponent(function (BlockEdit) {
	/**
  ...
  */
	function fetch(props) {
		var image = new wp.api.models.Media({ id: props.attributes.id }),
		...
		image.fetch({ attribute: 'smush' }).done(function (img) {
			...
			} else if ('undefined' !== typeof img.smush && ('undefined' === typeof smushData || JSON.stringify(smushData) !== JSON.stringify(img.smush))) {
				props.setAttributes({ smush: img.smush });
			}
		});
	}
  ...
  */
	return function (props) {
		...
		var smushData = props.attributes.smush;
		fetch(props);

		return el(wp.element.Fragment, {}, el(BlockEdit, props), el(wp.editor.InspectorControls, {}, el(wp.components.PanelBody, {
