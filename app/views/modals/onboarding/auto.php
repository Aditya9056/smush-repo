<div class="sui-dialog sui-dialog-sm smush-onboarding-dialog" tabindex="-1" id="smush-onboarding-dialog-auto">
        ...
        <div class="sui-box" role="document">
            <div class="sui-box-header sui-dialog-with-image">
                <div class="sui-dialog-image" aria-hidden="true">
                    <img src="<?php echo esc_url( WP_SMUSH_URL . 'app/assets/images/onboarding/auto.png' ); ?>" alt="<?php esc_attr_e( 'Automatic Compression', 'wp-smushit' ); ?>" class="sui-image sui-image-center">
                </div>
            ...
            <div class="sui-box-body">
                <p><?php esc_html_e( 'When you upload images to your site, Smush can automatically optimize and compress them for you saving you having to do this manually.', 'wp-smushit' ); ?></p>
                ...
                <div class="smush-onboarding-arrows">
                    <a href="#" class="previous" data-slide="smush-onboarding-dialog" onclick="WP_Smush.onboarding.nav(this)">
                        <i class="sui-icon-chevron-left" aria-hidden="true"></i>
                    </a>
                    <a href="#" class="next" data-slide="smush-onboarding-dialog-lossy" onclick="WP_Smush.onboarding.nav(this)">
