...
class Ajax {
	...
	public function __construct() {
		...
		// Ajax request for opt-in.
		add_action( 'wp_ajax_submit_opt_in_modal', array( $this, 'submit_opt_in_modal' ) );
	...
	/**
	* Process ajax action for hiding opt-in modal.
	*/
	public function submit_opt_in_modal() {
		check_ajax_referer( 'submit_opt_in_modal' );
		update_option( 'submit_opt_in_modal', true );
