...
if ( ! defined( 'WP_SMUSH_VERSION' ) ) {
	define( 'WP_SMUSH_VERSION', '3.6.0-alpha.1' );
}
...
if ( ! class_exists( 'Smush\\WP_Smush' ) ) {
	...
	class WP_Smush {
		...
		public function register_free_modules() {
			...
			do_action( 'wpmudev-recommended-plugins-register-notice', WPHB_BASENAME, __( 'Smush', 'wp-smushit' ), \Smush\App\Admin::$plugin_pages );
		}
